...
//     private final boolean DISPLAY_ID = true;
    ...
    /**
     * minimum width of a node boundary or edge
     */
    public final int MINIMUM_WIDTH = 2;

    /**
     * Diameter of a node (eventually this should be a preference)
     */
    private final int DEFAULT_NODE_RADIUS = 12;
	 ...
	 */
	private int edgeWidth = MINIMUM_WIDTH;
	...
	public void paintComponent(Graphics g) {
        try {
            ...
            if ( this.edgeWidth < 1 ) this.edgeWidth = MINIMUM_WIDTH;
...
//  [Last modified: 2015 05 29 at 14:24:33 GMT]
