...
\Code{\emph{s\_one}.equals(\emph{s\_two})}, where \emph{s\_one} and
\emph{s\_two} are strings (of type \Code{String}) is the only means of
...
\Code{\emph{s\_one}.compareTo(\emph{s\_two})}, which returns a positive
...
% [Last modified: 2017 01 16 at 18:30:28 GMT]
