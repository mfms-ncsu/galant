...
\item[converts the \Code{algorithm}] code to the run
...
to a \Code{CompilationException}; abd (ii)~the \Code{loadAlgorithm} method
...
% [Last modified: 2016 12 29 at 20:40:29 GMT]
