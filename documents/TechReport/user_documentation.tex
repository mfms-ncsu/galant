...
Fig.~\ref{fig:graph_window_annotated}. In the current version the text
page and tree icons are on the left instead of the right.}
...
This is an older version of Dijkstra's algorithm.}
