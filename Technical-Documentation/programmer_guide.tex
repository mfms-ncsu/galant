...
\begin{itemize}
  \item \Code{set($g$, String \emph{attribute}, $\langle \mathit{type} \rangle$ \emph{value})},
    ...
    or \Code{Double}.
  \item \Code{set($g$, String \emph{attribute})}; here the attribute is assumed to
    be Boolean and the value is implicitly \Code{true}.
...
% [Last modified: 2017 01 10 at 22:26:55 GMT]
