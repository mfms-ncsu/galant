...
\item
  ...
  the graph is read and displayed. This is because there is no state
  information available at the point when the graph is read. It's not clear
  what the right solution is. Probably check if an algorithm is running, and,
  if not, use the stateless variant of the attribute retrieval.
...
% [Last modified: 2017 07 21 at 19:08:35 GMT]
